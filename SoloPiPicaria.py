"""
====================================================================================================
Program Name: SoloPiPicaria

Description: This program implements a graphical user interface (GUI) version of the traditional 
             game Picaria. SoloPiPicaria is designed to run on a Raspberry Pi 4/5 computer, where
             both players operate the same system and alternate turns.
